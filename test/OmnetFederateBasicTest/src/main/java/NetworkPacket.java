...
public class NetworkPacket extends ActionBase {
	...
	*/
	...
	private static final String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.NetworkPacket:  could not initialize:  ";
	...
	private static final String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.NetworkPacket:  could not publish:  ";
	...
	*/
	...
	private static final String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.NetworkPacket:  could not unpublish:  ";
	/**
	...
	*/
	...
	private static final String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.NetworkPacket:  could not subscribe:  ";
	/**
	...
	*/
	...
	private static final String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.ActionBase.NetworkPacket:  could not unsubscribe:  ";
	/**
	...
	*/
	public Object getParameter( String datamemberName ) {
		...
		else if (  "numBytes".equals( datamemberName )  ) return get_numBytes();
		else if (  "packetType".equals( datamemberName )  ) return get_packetType();
		else if (  "receiverAppIndex".equals( datamemberName )  ) return get_receiverAppIndex();
		...
		else if (  "senderAppIndex".equals( datamemberName )  ) return get_senderAppIndex();
	...
	*/
	public Object getParameter( int datamemberHandle ) {
		...
		else if ( get_numBytes_handle() == datamemberHandle ) return get_numBytes();
		else if ( get_packetType_handle() == datamemberHandle ) return get_packetType();
		else if ( get_receiverAppIndex_handle() == datamemberHandle ) return get_receiverAppIndex();
		...
		else if ( get_senderAppIndex_handle() == datamemberHandle ) return get_senderAppIndex();
