...
bool OutcomeBase::static_init() {
    ...
    get_class_name_instance_sp_map()[get_hla_class_name()] = SP(new OutcomeBase());
...
int OutcomeBase::get_parameter_handle_aux(const std::string &className, const std::string &propertyName) {
...
void OutcomeBase::publish_interaction(RTI::RTIambassador *rti) {
    if (get_is_published()) {
        return;
    }
...
void OutcomeBase::unpublish_interaction(RTI::RTIambassador *rti) {
...
void OutcomeBase::subscribe_interaction(RTI::RTIambassador *rti) {
...
void OutcomeBase::unsubscribe_interaction(RTI::RTIambassador *rti) {
...
OutcomeBase::PropertyClassNameAndValueSP OutcomeBase::getParameterAux(
