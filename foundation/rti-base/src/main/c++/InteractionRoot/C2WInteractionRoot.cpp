...
void InteractionRoot::init(RTIambassador rti) {
    ...
    while(isNotInitialized) {
        try {
            ...
            classAndPropertyNameSP = ClassAndPropertyNameSP(get_hla_class_name(), "actualLogicalGenerationTime");
            ...
            classAndPropertyNameSP = ClassAndPropertyNameSP(get_hla_class_name(), "federateFilter");
            get_class_and_property_name_handle_map()[*classAndPropertyNameSP] = propertyHandle;
            get_handle_class_and_property_name_sp_map[propertyHandle] = classAndPropertyNameSP;

            propertyHandle = rti.getParameterHandle("originFed", get_class_handle());
            classAndPropertyNameSP = ClassAndPropertyNameSP(get_hla_class_name(), "originFed");
            get_class_and_property_name_handle_map()[*classAndPropertyNameSP] = propertyHandle;
            get_handle_class_and_property_name_sp_map[propertyHandle] = classAndPropertyNameSP;

            propertyHandle = rti.getParameterHandle("sourceFed", get_class_handle());
            classAndPropertyNameSP = ClassAndPropertyNameSP(get_hla_class_name(), "sourceFed");
            get_class_and_property_name_handle_map()[*classAndPropertyNameSP] = propertyHandle;
            get_handle_class_and_property_name_sp_map[propertyHandle] = classAndPropertyNameSP;
