...
void C2WInteractionRoot::init( RTI::RTIambassador *rti ) {
	...
	while( isNotInitialized ) {
		try {
			getHandle() = rti->getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot" );
	...
	getClassNameHandleMap().insert(  std::make_pair( "C2WInteractionRoot", get_handle() )  );
	getClassHandleNameMap().insert(  std::make_pair( get_handle(), "C2WInteractionRoot" )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "C2WInteractionRoot.actualLogicalGenerationTime", get_actualLogicalGenerationTime_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "C2WInteractionRoot.federateFilter", get_federateFilter_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "C2WInteractionRoot.originFed", get_originFed_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "C2WInteractionRoot.sourceFed", get_sourceFed_handle() )  );
...
void C2WInteractionRoot::publish( RTI::RTIambassador *rti ) {
	if ( getIsPublished() ) {
		return;
	}
...
void C2WInteractionRoot::unpublish( RTI::RTIambassador *rti ) {
	if ( !getIsPublished() ) {
		return;
	}
...
void C2WInteractionRoot::subscribe( RTI::RTIambassador *rti ) {
	if ( getIsSubscribed() ) {
		return;
	}
...
void C2WInteractionRoot::unsubscribe( RTI::RTIambassador *rti ) {
	if ( !getIsSubscribed() ) {
		return;
	}
...
bool C2WInteractionRoot::static_init( void ) {
	static bool isInitialized = false;
	if ( isInitialized ) {
		return true;
	}
	...
	getClassNameSet().insert( "C2WInteractionRoot" );

	getClassNameFactoryMap().insert(  std::make_pair( "C2WInteractionRoot", &C2WInteractionRoot::factory )  );
	getClassNamePublishMap().insert(   std::make_pair(  "C2WInteractionRoot", (PubsubFunctionPtr)( &C2WInteractionRoot::publish )  )   );
	getClassNameUnpublishMap().insert(   std::make_pair(  "C2WInteractionRoot", (PubsubFunctionPtr)( &C2WInteractionRoot::unpublish )  )   );
	getClassNameSubscribeMap().insert(   std::make_pair(  "C2WInteractionRoot", (PubsubFunctionPtr)( &C2WInteractionRoot::subscribe )  )   );
	getClassNameUnsubscribeMap().insert(   std::make_pair(  "C2WInteractionRoot", (PubsubFunctionPtr)( &C2WInteractionRoot::unsubscribe )  )   );

	getDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "C2WInteractionRoot", &getDatamemberNames() )  );
	getAllDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "C2WInteractionRoot", &getAllDatamemberNames() )  );
