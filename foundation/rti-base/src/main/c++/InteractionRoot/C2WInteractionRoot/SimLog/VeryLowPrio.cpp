...
void VeryLowPrio::init( RTI::RTIambassador *rti ) {
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "VeryLowPrio.Comment", get_Comment_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "VeryLowPrio.FedName", get_FedName_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "VeryLowPrio.Time", get_Time_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "VeryLowPrio.actualLogicalGenerationTime", get_actualLogicalGenerationTime_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "VeryLowPrio.federateFilter", get_federateFilter_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "VeryLowPrio.originFed", get_originFed_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "VeryLowPrio.sourceFed", get_sourceFed_handle() )  );
