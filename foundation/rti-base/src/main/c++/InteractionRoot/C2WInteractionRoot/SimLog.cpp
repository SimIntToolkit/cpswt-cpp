...
void InteractionRoot::init(RTIambassador rti) {
    ...
    while(isNotInitialized) {
        try {
            ...
            classAndPropertyNameSP = ClassAndPropertyNameSP(get_hla_class_name(), "Comment");
            ...
            classAndPropertyNameSP = ClassAndPropertyNameSP(get_hla_class_name(), "FedName");
            get_class_and_property_name_handle_map()[*classAndPropertyNameSP] = propertyHandle;
            get_handle_class_and_property_name_sp_map[propertyHandle] = classAndPropertyNameSP;

            propertyHandle = rti.getParameterHandle("Time", get_class_handle());
            classAndPropertyNameSP = ClassAndPropertyNameSP(get_hla_class_name(), "Time");
            get_class_and_property_name_handle_map()[*classAndPropertyNameSP] = propertyHandle;
            get_handle_class_and_property_name_sp_map[propertyHandle] = classAndPropertyNameSP;
