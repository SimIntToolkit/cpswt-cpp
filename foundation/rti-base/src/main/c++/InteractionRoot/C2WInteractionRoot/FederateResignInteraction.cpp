...
void InteractionRoot::init(RTIambassador rti) {
    ...
    while(isNotInitialized) {
        try {
            ...
            classAndPropertyNameSP = ClassAndPropertyNameSP(get_hla_class_name(), "FederateId");
            ...
            classAndPropertyNameSP = ClassAndPropertyNameSP(get_hla_class_name(), "IsLateJoiner");
            get_class_and_property_name_handle_map()[*classAndPropertyNameSP] = propertyHandle;
            get_handle_class_and_property_name_sp_map[propertyHandle] = classAndPropertyNameSP;
