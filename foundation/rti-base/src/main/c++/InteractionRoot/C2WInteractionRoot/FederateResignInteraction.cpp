...
void FederateResignInteraction::init( RTI::RTIambassador *rti ) {
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "FederateResignInteraction.actualLogicalGenerationTime", get_actualLogicalGenerationTime_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "FederateResignInteraction.federateFilter", get_federateFilter_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "FederateResignInteraction.originFed", get_originFed_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "FederateResignInteraction.sourceFed", get_sourceFed_handle() )  );
...
std::ostream &operator<<( std::ostream &os, const FederateResignInteraction &entity ) {
	return os << "FederateResignInteraction("
