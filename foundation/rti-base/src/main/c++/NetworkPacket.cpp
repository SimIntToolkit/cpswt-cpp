...
std::ostream &operator<<( std::ostream &os, const NetworkPacket &entity ) {
	return os << "NetworkPacket("  << "receiverHost:" << entity.get_receiverHost() << ", " << "numBytes:" << entity.get_numBytes() << ", " << "data:" << entity.get_data() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "receiverAppIndex:" << entity.get_receiverAppIndex() << ", " << "receiverHostApp:" << entity.get_receiverHostApp() << ", " << "senderHostApp:" << entity.get_senderHostApp() << ", " << "packetType:" << entity.get_packetType() << ", " << "senderHost:" << entity.get_senderHost() << ", " << "originFed:" << entity.get_originFed() << ", " << "receiverAppInterface:" << entity.get_receiverAppInterface() << ", " << "senderAppIndex:" << entity.get_senderAppIndex() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
