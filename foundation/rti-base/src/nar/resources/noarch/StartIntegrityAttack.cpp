...
void StartIntegrityAttack::init( RTI::RTIambassador *rti ) {
	...
	while( isNotInitialized ) {
		try {
			getHandle() = rti->getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ActionBase.OmnetCommand.StartIntegrityAttack" );
	...
	getClassNameHandleMap().insert(  std::make_pair( "StartIntegrityAttack", get_handle() )  );
	getClassHandleNameMap().insert(  std::make_pair( get_handle(), "StartIntegrityAttack" )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StartIntegrityAttack,intMultiplier", get_intMultiplier_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StartIntegrityAttack,doubleMultiplier", get_doubleMultiplier_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StartIntegrityAttack,doubleAdder", get_doubleAdder_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StartIntegrityAttack,booleanEnableFlip", get_booleanEnableFlip_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StartIntegrityAttack,longMultiplier", get_longMultiplier_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StartIntegrityAttack,nodeFullPath", get_nodeFullPath_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StartIntegrityAttack,stringReplacement", get_stringReplacement_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StartIntegrityAttack,longAdder", get_longAdder_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "StartIntegrityAttack,intAdder", get_intAdder_handle() )  );
...
void StartIntegrityAttack::publish( RTI::RTIambassador *rti ) {
	if ( getIsPublished() ) {
		return;
	}
...
void StartIntegrityAttack::unpublish( RTI::RTIambassador *rti ) {
	if ( !getIsPublished() ) {
		return;
	}
...
void StartIntegrityAttack::subscribe( RTI::RTIambassador *rti ) {
	if ( getIsSubscribed() ) {
		return;
	}
...
void StartIntegrityAttack::unsubscribe( RTI::RTIambassador *rti ) {
	if ( !getIsSubscribed() ) {
		return;
	}
...
bool StartIntegrityAttack::static_init( void ) {
	static bool isInitialized = false;
	if ( isInitialized ) {
		return true;
	}
	...
	getClassNameSet().insert( "StartIntegrityAttack" );
	
	getClassNameFactoryMap().insert(  std::make_pair( "StartIntegrityAttack", &StartIntegrityAttack::factory )  );
	getClassNamePublishMap().insert(   std::make_pair(  "StartIntegrityAttack", (PubsubFunctionPtr)( &StartIntegrityAttack::publish )  )   );
	getClassNameUnpublishMap().insert(   std::make_pair(  "StartIntegrityAttack", (PubsubFunctionPtr)( &StartIntegrityAttack::unpublish )  )   );
	getClassNameSubscribeMap().insert(   std::make_pair(  "StartIntegrityAttack", (PubsubFunctionPtr)( &StartIntegrityAttack::subscribe )  )   );
	getClassNameUnsubscribeMap().insert(   std::make_pair(  "StartIntegrityAttack", (PubsubFunctionPtr)( &StartIntegrityAttack::unsubscribe )  )   );

	getDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "StartIntegrityAttack", &getDatamemberNames() )  );
	getAllDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "StartIntegrityAttack", &getAllDatamemberNames() )  );
...
std::ostream &operator<<( std::ostream &os, StartIntegrityAttack::SP entitySP ) {
	return os << *entitySP;
}
std::ostream &operator<<( std::ostream &os, const StartIntegrityAttack &entity ) {
	return os << "StartIntegrityAttack("  << "intMultiplier:" << entity.get_intMultiplier() << ", " << "doubleMultiplier:" << entity.get_doubleMultiplier() << ", " << "doubleAdder:" << entity.get_doubleAdder() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "uniqueCommandID:" << entity.get_uniqueCommandID() << ", " << "booleanEnableFlip:" << entity.get_booleanEnableFlip() << ", " << "longMultiplier:" << entity.get_longMultiplier() << ", " << "nodeFullPath:" << entity.get_nodeFullPath() << ", " << "originFed:" << entity.get_originFed() << ", " << "stringReplacement:" << entity.get_stringReplacement() << ", " << "longAdder:" << entity.get_longAdder() << ", " << "intAdder:" << entity.get_intAdder() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
...
StartIntegrityAttack::ParameterHandleValuePairSetSP StartIntegrityAttack::createDatamemberHandleValuePairSet( RTI::ULong count ) {
