...
std::ostream &operator<<( std::ostream &os, const VeryLowPrio &entity ) {
	return os << "VeryLowPrio("  << "Time:" << entity.get_Time() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "FedName:" << entity.get_FedName() << ", " << "originFed:" << entity.get_originFed() << ", " << "Comment:" << entity.get_Comment() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime()	<< ")";
}
