...
public class GridlabDInput extends C2WInteractionRoot {
	...
	*/
	public Object getParameter( String datamemberName ) {
		...
		if (  "ObjectName".equals( datamemberName )  ) return get_ObjectName();
	...
	*/
	public Object getParameter( int datamemberHandle ) {
		...
		if ( get_ObjectName_handle() == datamemberHandle ) return get_ObjectName();
	...
	protected boolean setParameterAux( int param_handle, String val ) {
		...
		if ( param_handle == get_ObjectName_handle() ) set_ObjectName( val );
	...
	protected boolean setParameterAux( String datamemberName, String val ) {
		...
		if (  "ObjectName".equals( datamemberName )  ) set_ObjectName( val );
	...
	protected boolean setParameterAux( String datamemberName, Object val ) {
		...
		if (  "ObjectName".equals( datamemberName )  ) set_ObjectName( (String)val );
