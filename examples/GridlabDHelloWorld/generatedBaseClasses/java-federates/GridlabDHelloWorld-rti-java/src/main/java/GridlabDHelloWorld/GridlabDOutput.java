...
/**
* The GridlabDOutput class implements the GridlabDOutput interaction in the
* GridlabDHelloWorld simulation.
*/
public class GridlabDOutput extends C2WInteractionRoot {

	/**
	* Default constructor -- creates an instance of the GridlabDOutput interaction
	* class with default parameter values.
	*/
	public GridlabDOutput() { }
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the GridlabDOutput interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the GridlabDOutput
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.GridlabDOutput"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the GridlabDOutput interaction class.
	*/
	public static String get_simple_class_name() { return "GridlabDOutput"; }
	...
	* GridlabDOutput interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add( "InteractionRoot.C2WInteractionRoot.GridlabDOutput" );
		_classNameClassMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDOutput", GridlabDOutput.class );
		
		_datamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDOutput", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDOutput", _allDatamemberNames );
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.GridlabDOutput:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.GridlabDOutput" );
		...
		_classNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDOutput", get_handle() );
		_classHandleNameMap.put( get_handle(), "InteractionRoot.C2WInteractionRoot.GridlabDOutput" );
		_classHandleSimpleNameMap.put( get_handle(), "GridlabDOutput" );
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDOutput,Parameter", get_Parameter_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDOutput,Value", get_Value_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDOutput,Operation", get_Operation_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDOutput,ObjectName", get_ObjectName_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDOutput,Units", get_Units_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDOutput,ModelName", get_ModelName_handle() );
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.GridlabDOutput:  could not publish:  ";

	/**
	* Publishes the GridlabDOutput interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.GridlabDOutput:  could not unpublish:  ";
	/**
	* Unpublishes the GridlabDOutput interaction class for a federate.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.GridlabDOutput:  could not subscribe:  ";
	/**
	* Subscribes a federate to the GridlabDOutput interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.GridlabDOutput:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the GridlabDOutput interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	* (that is, the GridlabDOutput interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the GridlabDOutput interaction class).
	...
	*/
	...
	protected GridlabDOutput( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected GridlabDOutput( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the GridlabDOutput interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new GridlabDOutput interaction class instance
	*/
	public GridlabDOutput( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #GridlabDOutput( ReceivedInteraction datamemberMap )}, except this
	* new GridlabDOutput interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new GridlabDOutput interaction class instance
	* @param logicalTime timestamp for this new GridlabDOutput interaction class
	* instance
	*/
	public GridlabDOutput( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new GridlabDOutput interaction class instance that is a duplicate
	* of the instance referred to by GridlabDOutput_var.
	*
	* @param GridlabDOutput_var GridlabDOutput interaction class instance of which
	* this newly created GridlabDOutput interaction class instance will be a
	* duplicate
	*/
	public GridlabDOutput( GridlabDOutput GridlabDOutput_var ) {
		super( GridlabDOutput_var );
		
		
		set_Parameter( GridlabDOutput_var.get_Parameter() );
		set_Value( GridlabDOutput_var.get_Value() );
		set_Operation( GridlabDOutput_var.get_Operation() );
		set_ObjectName( GridlabDOutput_var.get_ObjectName() );
		set_Units( GridlabDOutput_var.get_Units() );
		set_ModelName( GridlabDOutput_var.get_ModelName() );
	}
	...
	*/
	public Object getParameter( String datamemberName ) {
		...
		if (  "Parameter".equals( datamemberName )  ) return get_Parameter();
	...
	*/
	public Object getParameter( int datamemberHandle ) {
		...
		if ( get_Parameter_handle() == datamemberHandle ) return get_Parameter();
	...
	protected boolean setParameterAux( int param_handle, String val ) {
		...
		if ( param_handle == get_Parameter_handle() ) set_Parameter( val );
	...
	protected boolean setParameterAux( String datamemberName, String val ) {
		...
		if (  "Parameter".equals( datamemberName )  ) set_Parameter( val );
	...
	protected boolean setParameterAux( String datamemberName, Object val ) {
		...
		if (  "Parameter".equals( datamemberName )  ) set_Parameter( (String)val );
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof GridlabDOutput ) {
			GridlabDOutput data = (GridlabDOutput)object;
