...
/**
* The GridlabDControl class implements the GridlabDControl interaction in the
* GridlabDHelloWorld simulation.
*/
public class GridlabDControl extends C2WInteractionRoot {

	/**
	* Default constructor -- creates an instance of the GridlabDControl interaction
	* class with default parameter values.
	*/
	public GridlabDControl() { }

	
	
	private static int _Period_handle;
	private static int _IsControl_handle;
	...
	/**
	* Returns the handle (RTI assigned) of the "Period" parameter of
	* its containing interaction class.
	*
	* @return the handle (RTI assigned) of the "Period" parameter
	*/
	public static int get_Period_handle() { return _Period_handle; }
	
	/**
	* Returns the handle (RTI assigned) of the "IsControl" parameter of
	* its containing interaction class.
	*
	* @return the handle (RTI assigned) of the "IsControl" parameter
	*/
	public static int get_IsControl_handle() { return _IsControl_handle; }
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the GridlabDControl interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the GridlabDControl
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.GridlabDControl"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the GridlabDControl interaction class.
	*/
	public static String get_simple_class_name() { return "GridlabDControl"; }
	...
	* GridlabDControl interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	...
	static {
		_classNameSet.add( "InteractionRoot.C2WInteractionRoot.GridlabDControl" );
		_classNameClassMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDControl", GridlabDControl.class );
		
		_datamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDControl", _datamemberNames );
		_allDatamemberClassNameSetMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDControl", _allDatamemberNames );

		
		
		_datamemberNames.add( "Period" );
		_datamemberNames.add( "IsControl" );
		...
		_allDatamemberNames.add( "IsControl" );
		...
		_datamemberTypeMap.put( "Period", "double" );
		_datamemberTypeMap.put( "IsControl", "boolean" );
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.GridlabDControl:  could not initialize:  ";
	protected static void init( RTIambassador rti ) {
		...
		while( isNotInitialized ) {
			try {
				_handle = rti.getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.GridlabDControl" );
		...
		_classNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDControl", get_handle() );
		_classHandleNameMap.put( get_handle(), "InteractionRoot.C2WInteractionRoot.GridlabDControl" );
		_classHandleSimpleNameMap.put( get_handle(), "GridlabDControl" );
		...
		while( isNotInitialized ) {
			try {
				...
				_Period_handle = rti.getParameterHandle( "Period", get_handle() );			
				_IsControl_handle = rti.getParameterHandle( "IsControl", get_handle() );			
		...
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDControl,Period", get_Period_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDControl,IsControl", get_IsControl_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDControl,ObjectName", get_ObjectName_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDControl,Operation", get_Operation_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDControl,ModelName", get_ModelName_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDControl,Value", get_Value_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDControl,Parameter", get_Parameter_handle() );
		_datamemberNameHandleMap.put( "InteractionRoot.C2WInteractionRoot.GridlabDControl,Units", get_Units_handle() );
			
			
		_datamemberHandleNameMap.put( get_Period_handle(), "Period" );
		_datamemberHandleNameMap.put( get_IsControl_handle(), "IsControl" );
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.GridlabDControl:  could not publish:  ";

	/**
	* Publishes the GridlabDControl interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.GridlabDControl:  could not unpublish:  ";
	/**
	* Unpublishes the GridlabDControl interaction class for a federate.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.GridlabDControl:  could not subscribe:  ";
	/**
	* Subscribes a federate to the GridlabDControl interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.GridlabDControl:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the GridlabDControl interaction class.
	*
	* @param rti handle to the RTI, usu. obtained through the
	* {@link SynchronizedFederate#getRTI()} call
	*/
	...
	* (that is, the GridlabDControl interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the GridlabDControl interaction class).
	...
	*/
	...
	public String toString() {
		return "GridlabDControl("
			
			
			+ "Period:" + get_Period()
			+ "," + "IsControl:" + get_IsControl()
	...
	/**
	* Set the value of the "Period" parameter to "value" for this parameter.
	*
	* @param value the new value for the "Period" parameter
	*/
	public void set_Period( double value ) { _Period = value; }
	
	/**
	* Returns the value of the "Period" parameter of this interaction.
	*
	* @return the value of the "Period" parameter
	*/
	public double get_Period() { return _Period; }
	
	
	/**
	* Set the value of the "IsControl" parameter to "value" for this parameter.
	*
	* @param value the new value for the "IsControl" parameter
	*/
	public void set_IsControl( boolean value ) { _IsControl = value; }
	
	/**
	* Returns the value of the "IsControl" parameter of this interaction.
	*
	* @return the value of the "IsControl" parameter
	*/
	public boolean get_IsControl() { return _IsControl; }
	...
	*/
	...
	protected GridlabDControl( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected GridlabDControl( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the GridlabDControl interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new GridlabDControl interaction class instance
	*/
	public GridlabDControl( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #GridlabDControl( ReceivedInteraction datamemberMap )}, except this
	* new GridlabDControl interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new GridlabDControl interaction class instance
	* @param logicalTime timestamp for this new GridlabDControl interaction class
	* instance
	*/
	public GridlabDControl( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new GridlabDControl interaction class instance that is a duplicate
	* of the instance referred to by GridlabDControl_var.
	*
	* @param GridlabDControl_var GridlabDControl interaction class instance of which
	* this newly created GridlabDControl interaction class instance will be a
	* duplicate
	*/
	public GridlabDControl( GridlabDControl GridlabDControl_var ) {
		super( GridlabDControl_var );
		
		
		set_Period( GridlabDControl_var.get_Period() );
		set_IsControl( GridlabDControl_var.get_IsControl() );
		set_ObjectName( GridlabDControl_var.get_ObjectName() );
		set_Operation( GridlabDControl_var.get_Operation() );
		set_ModelName( GridlabDControl_var.get_ModelName() );
		set_Value( GridlabDControl_var.get_Value() );
		set_Parameter( GridlabDControl_var.get_Parameter() );
		set_Units( GridlabDControl_var.get_Units() );
	}
	...
	*/
	public Object getParameter( String datamemberName ) {
		...
		if (  "Period".equals( datamemberName )  ) return new Double( get_Period() );
		else if (  "IsControl".equals( datamemberName )  ) return new Boolean( get_IsControl() );
		...
		else if (  "ModelName".equals( datamemberName )  ) return get_ModelName();
	...
	*/
	public Object getParameter( int datamemberHandle ) {
		...
		if ( get_Period_handle() == datamemberHandle ) return new Double( get_Period() );
		else if ( get_IsControl_handle() == datamemberHandle ) return new Boolean( get_IsControl() );
		...
		else if ( get_ModelName_handle() == datamemberHandle ) return get_ModelName();
	...
	protected boolean setParameterAux( int param_handle, String val ) {
		...
		if ( param_handle == get_Period_handle() ) set_Period( Double.parseDouble( val ) );
		else if ( param_handle == get_IsControl_handle() ) set_IsControl( Boolean.parseBoolean( val ) );
		...
		else if ( param_handle == get_ModelName_handle() ) set_ModelName( val );
	...
	protected boolean setParameterAux( String datamemberName, String val ) {
		...
		if (  "Period".equals( datamemberName )  ) set_Period( Double.parseDouble( val ) );
		else if (  "IsControl".equals( datamemberName )  ) set_IsControl( Boolean.parseBoolean( val ) );
		...
		else if (  "ModelName".equals( datamemberName )  ) set_ModelName( val );
	...
	protected boolean setParameterAux( String datamemberName, Object val ) {
		...
		if (  "Period".equals( datamemberName )  ) set_Period( (Double)val );
		else if (  "IsControl".equals( datamemberName )  ) set_IsControl( (Boolean)val );
		...
		else if (  "ModelName".equals( datamemberName )  ) set_ModelName( (String)val );
	...
	protected SuppliedParameters createSuppliedDatamembers() {
		SuppliedParameters datamembers = super.createSuppliedDatamembers();
			...
			datamembers.add( get_Period_handle(), Double.toString( get_Period() ).getBytes() );
		
			datamembers.add( get_IsControl_handle(), Boolean.toString( get_IsControl() ).getBytes() );
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof GridlabDControl ) {
			GridlabDControl data = (GridlabDControl)object;
			
			
				_Period = data._Period;
				_IsControl = data._IsControl;
