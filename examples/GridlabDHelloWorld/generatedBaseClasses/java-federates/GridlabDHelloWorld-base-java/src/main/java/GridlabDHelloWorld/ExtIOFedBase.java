...
public class ExtIOFedBase extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public ExtIOFedBase( String federation_id, String federate_id ) throws Exception {
        ...
        GridlabDControl.publish( getRTI() );
        		
		// object pubsub
                        }
        
       // constructor
	public ExtIOFedBase(  String[] federationInfo ) throws Exception {
		...
		if(federationInfo.length  > 2) {
			...
			GridlabDInput.enablePublishLog(
				"GridlabDInput",
				"ExtIOFed",
				"NORMAL",
				loglevel);
			GridlabDControl.enablePublishLog(
				"GridlabDControl",
				"ExtIOFed",
				"NORMAL",
				loglevel);
	...
	public GridlabDInput create_GridlabDInput() {
	   GridlabDInput interaction = new GridlabDInput();
	   interaction.set_sourceFed( getFederateId() );
	   interaction.set_originFed( getFederateId() );
	   return interaction;
	}
	public GridlabDControl create_GridlabDControl() {
	   GridlabDControl interaction = new GridlabDControl();
	   interaction.set_sourceFed( getFederateId() );
	   interaction.set_originFed( getFederateId() );
	   return interaction;
	}
