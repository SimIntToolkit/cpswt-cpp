...
std::ostream &operator<<( std::ostream &os, const ActionBase &entity ) {
	return os << "ActionBase("  << "originFed:" << entity.get_originFed() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime() << ", " << "federateFilter:" << entity.get_federateFilter()	<< ")";
}
