...
void GridlabDOutput::init( RTI::RTIambassador *rti ) {
	...
	while( isNotInitialized ) {
		try {
			getHandle() = rti->getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.GridlabDOutput" );
	...
	getClassNameHandleMap().insert(  std::make_pair( "GridlabDOutput", get_handle() )  );
	getClassHandleNameMap().insert(  std::make_pair( get_handle(), "GridlabDOutput" )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "GridlabDOutput,Parameter", get_Parameter_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "GridlabDOutput,Value", get_Value_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "GridlabDOutput,Operation", get_Operation_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "GridlabDOutput,ObjectName", get_ObjectName_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "GridlabDOutput,Units", get_Units_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "GridlabDOutput,ModelName", get_ModelName_handle() )  );
...
void GridlabDOutput::publish( RTI::RTIambassador *rti ) {
	if ( getIsPublished() ) {
		return;
	}
...
void GridlabDOutput::unpublish( RTI::RTIambassador *rti ) {
	if ( !getIsPublished() ) {
		return;
	}
...
void GridlabDOutput::subscribe( RTI::RTIambassador *rti ) {
	if ( getIsSubscribed() ) {
		return;
	}
...
void GridlabDOutput::unsubscribe( RTI::RTIambassador *rti ) {
	if ( !getIsSubscribed() ) {
		return;
	}
...
bool GridlabDOutput::static_init( void ) {
	static bool isInitialized = false;
	if ( isInitialized ) {
		return true;
	}
	...
	getClassNameSet().insert( "GridlabDOutput" );
	
	getClassNameFactoryMap().insert(  std::make_pair( "GridlabDOutput", &GridlabDOutput::factory )  );
	getClassNamePublishMap().insert(   std::make_pair(  "GridlabDOutput", (PubsubFunctionPtr)( &GridlabDOutput::publish )  )   );
	getClassNameUnpublishMap().insert(   std::make_pair(  "GridlabDOutput", (PubsubFunctionPtr)( &GridlabDOutput::unpublish )  )   );
	getClassNameSubscribeMap().insert(   std::make_pair(  "GridlabDOutput", (PubsubFunctionPtr)( &GridlabDOutput::subscribe )  )   );
	getClassNameUnsubscribeMap().insert(   std::make_pair(  "GridlabDOutput", (PubsubFunctionPtr)( &GridlabDOutput::unsubscribe )  )   );

	getDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "GridlabDOutput", &getDatamemberNames() )  );
	getAllDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "GridlabDOutput", &getAllDatamemberNames() )  );
...
std::ostream &operator<<( std::ostream &os, GridlabDOutput::SP entitySP ) {
	return os << *entitySP;
}
std::ostream &operator<<( std::ostream &os, const GridlabDOutput &entity ) {
	return os << "GridlabDOutput("  << "originFed:" << entity.get_originFed() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "Parameter:" << entity.get_Parameter() << ", " << "Value:" << entity.get_Value() << ", " << "Operation:" << entity.get_Operation() << ", " << "ObjectName:" << entity.get_ObjectName() << ", " << "Units:" << entity.get_Units() << ", " << "ModelName:" << entity.get_ModelName() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime() << ", " << "federateFilter:" << entity.get_federateFilter()	<< ")";
}
...
GridlabDOutput::ParameterHandleValuePairSetSP GridlabDOutput::createDatamemberHandleValuePairSet( RTI::ULong count ) {
