...
std::ostream &operator<<( std::ostream &os, const GridlabDInput &entity ) {
	return os << "GridlabDInput("  << "originFed:" << entity.get_originFed() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "ObjectName:" << entity.get_ObjectName() << ", " << "Operation:" << entity.get_Operation() << ", " << "Parameter:" << entity.get_Parameter() << ", " << "ModelName:" << entity.get_ModelName() << ", " << "Units:" << entity.get_Units() << ", " << "Value:" << entity.get_Value() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime() << ", " << "federateFilter:" << entity.get_federateFilter()	<< ")";
}
