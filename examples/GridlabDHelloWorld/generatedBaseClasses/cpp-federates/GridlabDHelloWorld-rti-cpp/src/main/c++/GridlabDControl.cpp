...
std::ostream &operator<<( std::ostream &os, const GridlabDControl &entity ) {
	return os << "GridlabDControl("  << "Period:" << entity.get_Period() << ", " << "IsControl:" << entity.get_IsControl() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "ObjectName:" << entity.get_ObjectName() << ", " << "Operation:" << entity.get_Operation() << ", " << "ModelName:" << entity.get_ModelName() << ", " << "originFed:" << entity.get_originFed() << ", " << "Value:" << entity.get_Value() << ", " << "Parameter:" << entity.get_Parameter() << ", " << "Units:" << entity.get_Units() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime() << ", " << "federateFilter:" << entity.get_federateFilter()	<< ")";
}
