...
std::ostream &operator<<( std::ostream &os, const OutcomeBase &entity ) {
	return os << "OutcomeBase("  << "originFed:" << entity.get_originFed() << ", " << "sourceFed:" << entity.get_sourceFed() << ", " << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime() << ", " << "federateFilter:" << entity.get_federateFilter()	<< ")";
}
